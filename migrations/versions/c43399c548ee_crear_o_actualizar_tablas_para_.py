...
Revision ID: c43399c548ee
Revises: 
Create Date: 2025-09-09 13:45:39.848807
...
def upgrade():
    ...
    sa.Column('fecha_creacion', sa.DateTime(), nullable=True),
    sa.Column('correo_cliente', sa.String(length=120), nullable=True),
    ...
    sa.Column('estado', sa.Enum('PENDIENTE', 'EN_CAMINO', 'ENVIADO', name='estadoventa'), nullable=False),
